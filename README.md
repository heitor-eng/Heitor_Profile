...
* **[Data Visualization with Bar Chart Race and Waffle Plot - Open in the Google Colab](https://github.com/heitor-eng/H_Data_Science/blob/master/Bar_Chart_Race_Cereais_and_PyWaffle.ipynb)**
